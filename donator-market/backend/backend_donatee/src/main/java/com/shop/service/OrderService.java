...
public class OrderService {
        ...
        for (Order order : orders) {
            ...
            for (OrderItem orderItem : orderItems) {
                ...
                OrderItemDto orderItemDto =
                        new OrderItemDto(orderItem, itemImg.getImgUrl(), itemImg.getOriImgName());
    ...
    public String findByLogistic(String logistic) {
        return orderRepository.findByLogistics(logistic);
    }

    public Long orderCount(String email) {
